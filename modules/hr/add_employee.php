        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:2rem;">
            ...
            <div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; margin-bottom:1rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" class="form-control" required style="border-radius: 8px;">
                    </div>
                    <div class="form-group">
                        <label class="form-label" style="font-weight:600; color:var(--text-dark);">Last Name *</label>
                        <input type="text" name="last_name" class="form-control" required style="border-radius: 8px;">
                    </div>
                </div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; margin-bottom:1rem;">
                    <div class="form-group">
                        ...
                        <input type="tel" name="mobile" class="form-control" required style="border-radius: 8px;">
                    </div>
                    <div class="form-group">
                        <label class="form-label" style="font-weight:600; color:var(--text-dark);">Alternate Mobile</label>
                        <input type="tel" name="alt_mobile" class="form-control" style="border-radius: 8px;">
                    </div>
                </div>
                <div class="form-group" style="margin-bottom:1rem;">
                    <label class="form-label" style="font-weight:600; color:var(--text-dark);">WhatsApp Number</label>
                    <input type="tel" name="whatsapp" class="form-control" style="border-radius: 8px;">
                </div>
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; margin-bottom:1rem;">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="dob" class="form-control" style="border-radius: 8px;">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="form-group" style="margin-bottom:1rem;">
                    ...
                    <input type="text" name="street" class="form-control" style="border-radius: 8px;">
                </div>
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; margin-bottom:1rem;">
                    <div class="form-group">
                        <label class="form-label" style="font-weight:600; color:var(--text-dark);">City</label>
                        <input type="text" name="city" class="form-control" style="border-radius: 8px;">
                    </div>
                    <div class="form-group">
                        <label class="form-label" style="font-weight:600; color:var(--text-dark);">State</label>
                        <input type="text" name="state" class="form-control" style="border-radius: 8px;">
                    </div>
                </div>
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem; margin-bottom:1rem;">
                    <div class="form-group">
                        <label class="form-label" style="font-weight:600; color:var(--text-dark);">Country</label>
                        <input type="text" name="country" class="form-control" value="India" style="border-radius: 8px;">
                    </div>
                    <div class="form-group">
                        <label class="form-label" style="font-weight:600; color:var(--text-dark);">Pincode</label>
                        <input type="text" name="pincode" class="form-control" style="border-radius: 8px;">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="form-group" style="margin-bottom:1rem;">
                    ...
                    <input type="number" name="salary" class="form-control" required style="border-radius: 8px;">
                </div>
                <div class="form-group" style="margin-bottom:1rem;">
                    <label class="form-label" style="font-weight:600; color:var(--text-dark);">Date of Joining</label>
                    <input type="date" name="doj" class="form-control" value="2026-05-22" style="border-radius: 8px;">
                </div>
                <div class="form-group" style="margin-bottom:1rem;">
                    ...
                    <input type="number" name="punch_in_range" class="form-control" value="500" style="border-radius: 8px;">
