...
if ($role_id == 1) {
    $menus = [
        ...
        ['href' => 'modules/announcements/index.php', 'label' => 'Manage Announcement', 'icon' => 'announcement', 'match' => 'modules/announcements'],
        ['href' => 'modules/tasks/index.php', 'label' => 'Task Management', 'icon' => 'task', 'match' => 'modules/tasks'],
    ...
    $menus = [
        ['href' => 'index.php', 'label' => 'Dashboard', 'icon' => 'home', 'match' => 'index.php'],
        ['type' => 'section', 'label' => 'My Business'],
        ['href' => 'modules/crm/leads.php', 'label' => 'My Leads', 'icon' => 'crm', 'match' => 'modules/crm'],
...
function getSidebarIcon($name)
{
    $icons = [
        ...
        'announcement' => '<path d="M11 5L6 9H2v6h4l5 4V5z"></path><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path>',
    ];
...
<aside class="sidebar" id="sidebar">
    <!-- Logo / Brand -->
    <div class="sidebar-header" style="justify-content: flex-start; padding: 1.5rem 1.25rem;">
        <h2 style="color: var(--primary); font-weight: 700; font-size: 1.25rem; letter-spacing: -0.5px; margin: 0;">ERP Panel</h2>
    </div>
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo $href; ?>" class="nav-link <?php echo $active; ?>">
                            ...
                            <?php if ($badge > 0): ?>
                                <span class="nav-badge"><?php echo $badge > 99 ? '99+' : $badge; ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                <?php endif; ?>
        ...
        <div class="sidebar-user-card">
            ...
            <div>
                <div class="sidebar-user-name">
                    <?php echo htmlspecialchars(explode(' ', $user_name)[0] . ' ' . (explode(' ', $user_name)[1] ?? '')); ?>
                </div>
                <div class="sidebar-user-role"><?php echo htmlspecialchars($role_name); ?></div>
            </div>
        </div>
        <a href="<?php echo BASE_URL; ?>modules/auth/logout.php" class="btn-sign-out">
